...
var HTMLcontactGenericwithClass = '<li class="%class%"><a href="%link%" class="white-text contact-link-item" target="_blank">%data%</a></li>';
...
var HTMLskills = '<li class="flex-item">%header%:<span class="white-text">%data%</span></li>';
...
$(document).click(function(loc) {
    logClicks(window.event.pageX, window.event.pageY);
});
...
var zocialMediaClassMap = {
    "email": "flex-item zocial-gmail",
    "twitter": "flex-item zocial-twitter",
    "github": "flex-item zocial-github",
    "linkedin": "flex-item zocial-linkedin",
    "location": "flex-item zocial-pinboard"
};

var socialMediaLinkMap = {
    "email": "mailTo:jchaplin@gmail.com",
    "twitter": "https://twitter.com/jchaplin2",
    "github": "https://github.com/jchaplin2",
